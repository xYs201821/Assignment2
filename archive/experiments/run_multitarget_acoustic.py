...
from config import CommonConfig, MultiTargetConfig
from experiment_helper import configure_matplotlib, ensure_dir, to_numpy
...
def main() -> None:
    ...
    parser.add_argument("--T", type=int, default=40, help="Number of timesteps to simulate.")
